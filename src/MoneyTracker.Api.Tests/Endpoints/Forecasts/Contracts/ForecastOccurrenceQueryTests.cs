...
/// <summary>
/// Unit tests for ForecastOccurrenceQuery
/// </summary>
public class ForecastOccurrenceQueryTests
{
    [Fact]
    public void GetRequiredYearMonth_Should_Return_Valid_YearMonth_For_Valid_Format()
    {
        // Arrange
        var query = new ForecastOccurrenceQuery { Month = "2024-01" };
    ...
    {
        // Arrange
        var query = new ForecastOccurrenceQuery { Month = "2023-12" };
    ...
    {
        // Arrange
        var query = new ForecastOccurrenceQuery { Month = "2024-5" };
    ...
    {
        // Arrange
        var query = new ForecastOccurrenceQuery { Month = " 2024 - 03 " };
