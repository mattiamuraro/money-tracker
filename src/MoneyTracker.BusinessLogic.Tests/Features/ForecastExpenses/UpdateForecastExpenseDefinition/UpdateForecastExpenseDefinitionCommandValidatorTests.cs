...
public class UpdateForecastExpenseDefinitionCommandValidatorTests
{
    private readonly UpdateForecastExpenseDefinitionCommandValidator _validator = new();

    private static UpdateForecastExpenseDefinitionCommand ValidCommand() => new()
    {
        Id = Guid.NewGuid(),
        Description = "Rent",
        Amount = 800m,
