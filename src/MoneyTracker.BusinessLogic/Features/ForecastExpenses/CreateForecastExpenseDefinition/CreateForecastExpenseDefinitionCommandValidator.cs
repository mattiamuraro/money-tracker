...
public class CreateForecastExpenseDefinitionCommandValidator : AbstractValidator<CreateForecastExpenseDefinitionCommand>
{
    public CreateForecastExpenseDefinitionCommandValidator()
    {
