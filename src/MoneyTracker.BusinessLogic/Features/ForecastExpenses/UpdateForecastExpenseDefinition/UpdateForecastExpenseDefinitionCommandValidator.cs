...
public class UpdateForecastExpenseDefinitionCommandValidator : AbstractValidator<UpdateForecastExpenseDefinitionCommand>
{
    public UpdateForecastExpenseDefinitionCommandValidator()
    {
