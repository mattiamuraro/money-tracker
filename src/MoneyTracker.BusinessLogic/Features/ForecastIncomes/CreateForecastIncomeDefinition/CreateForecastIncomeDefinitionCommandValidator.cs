...
public class CreateForecastIncomeDefinitionCommandValidator : AbstractValidator<CreateForecastIncomeDefinitionCommand>
{
    public CreateForecastIncomeDefinitionCommandValidator()
    {
